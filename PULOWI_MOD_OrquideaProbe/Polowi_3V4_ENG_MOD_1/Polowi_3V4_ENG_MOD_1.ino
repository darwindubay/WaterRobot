...
void setup() {
  ...
  digitalWrite(PD2, LOW);  // sets the digital pin D2 on
  //digitalWrite(PD4, HIGH); // sets the digital pin D4 on  PITIDO
  delay(500);               // waits for a second
  digitalWrite(PD2, HIGH);  // sets the digital pin D2  ESTE ES EL RESET DE LA PANTALLA
  //digitalWrite(PD4, LOW);
  delay(500);           // waits for a second
  pinMode(PD3, INPUT);  //BOTON PARA INICIAR RONDA DE MEDICION
...
*/
  ...
  display.println("Press the RUN button");
  display.println("or use the APP to");
...
void escribaD(int sensornumber) {
  ...
  switch (sensornumber) {
    ...
    case 3:
      ...
      display.println("Electrical           Conductivity[uS/cm]:");
      break;
    case 4:
      display.print("Water Temperature    [C]: ");
      break;
    case 5:
    ...
    case 6:
      display.setCursor(0, 0);           // Start at top-left corner
      display.print("Pressure[kPa]: ");  // statements PresTemp
      display.println(pressureKPA);
      display.println("Air temperature[C]: ");  // statements PresTemp
